...
const PrivacyPolicy = ({ onClose }: { onClose: () => void }) => (
  ...
  >
    <div className="max-w-lg w-full p-8 rounded shadow-lg bg-white text-neutral-900 relative">
      ...
      <p className="mb-4">
        For more details on Formspree’s privacy practices, visit <a href="https://formspree.io/legal/privacy-policy" target="_blank" rel="noopener noreferrer" className="underline">Formspree Privacy Policy</a>.
      </p>
      <p>
